// Legacy, fixed Schema Versions from the stub-schema

// The first version of the schema, but using object notation for schemas and fields for easy modification
export const schemaV1_accessible = {
  sample_registration: {
  ...
  primary_diagnosis: {
    ...
    fields: {
      ...
      clinical_stage_group: {
        ...
        description:
          'Stage group of the tumour, as assigned by the reporting tumour_staging_system, that indicates the overall prognostic tumour stage (ie. Stage I, Stage II, Stage III etc.).',
        valueType: 'string',
        meta: {
          core: true,
        },
      ...
      stage_suffix: {
        name: 'stage_suffix',
        description:
          'If necessary, use this field to add any applicable stage suffixes. Stage suffixes may apply to certain staging systems such as Ann Arbour staging system where the four stages are divided into 4 categories (A, B, X and E).',
        valueType: 'string',
        meta: {
          core: true,
        },
      ...
      presenting_symptoms: {
        ...
        valueType: 'string',
        restrictions: {
          codeList: ['Back Pain', 'Nausea', 'None', 'Unknown', 'Weight Loss'],
        },
      },
      menopause_status: {
        name: 'menopause_status',
        description:
          'Indicate the menopause status of the patient at the time of primary diagnosis.',
        valueType: 'string',
        restrictions: {
  ...
  specimen: {
    ...
    fields: {
      ...
      central_pathology_confirmed: {
        name: 'central_pathology_confirmed',
        description:
          'Indicate whether the histologic description of tissue or cells was confirmed by a pathology review of frozen or formalin fixed slide(s) completed after the diagnostic pathology review of the tumour sample used to extract analyte(s).',
        valueType: 'string',
        restrictions: {
          required: true,
          codeList: ['Yes', 'No', 'Unknown', 'Not reported'],
        },
        meta: {
          core: true,
        },
      ...
      tumour_histological_type: {
        ...
        description:
          'The code to represent the histology (morphology) of neoplasms that is usually obtained from a pathology report, according to the International Classification of Diseases for Oncology, 3rd Edition (WHO ICD-O-3).',
        valueType: 'string',
        restrictions: {
          required: true,
          regex: 'M-[0-9]{4}/[0-9]{2}$',
      ...
      pathological_stage_group: {
        ...
        description:
          'Specify the tumour stage, based on tumor_staging_system, used to assess the cancer at the time the tumour specimen was resected.',
        valueType: 'string',
        restrictions: {
          required: true,
        },
  ...
  follow_up: {
    ...
    fields: {
      ...
      submitter_follow_up_id: {
        description:
          'Unique identifier for a follow-up event in a donors clincal record, assigned by the data provider.',
      ...
      relapse_type: {
        description:
          "Donor's relapse type if disease status at followup was progression or relapse.",
        name: 'relapse_type',
        valueType: 'string',
        restrictions: {
          codeList: [
      ...
      relapse_interval: {
        description:
          'If the donor was clinically disease free following primary treatment and then relapse or progression (for liquid tumours) occurred afterwards, then this field will indicate the length of disease free interval, in days.',
  ...
  treatment: {
    ...
    fields: {
      ...
      therapeutic_intent: {
        ...
        description:
          'The therapeutic intent, the reason behind the choice of a therapy, of the treatment.',
        valueType: 'string',
        restrictions: {
          required: true,
          codeList: [
  ...
  chemotherapy: {
    ...
    fields: {
      ...
      chemotherapy_drug_name: {
        ...
        description:
          'Name of agent or drug administered to patient as part of the chemotherapy treatment regimen.',
        valueType: 'string',
        restrictions: {
          required: true,
          codeList: ['Allopurinol', 'Dronabinol', 'Sucralfate', 'Lapatinib'],
        },
        meta: {
          core: true,
        },
...
export const schemaV3 = [
  {
    name: 'sample_registration',
    description:
      'Collection of elements required to register the required Donor-Specimen-Sample data to the ARGO Platform. Registration of samples is required before genomic and clinical data submission can proceed.',
    fields: [
      {
        name: 'program_id',
        valueType: 'string',
  ...
  },
  {
    name: 'donor',
    description:
      'The collection of data elements related to a specific donor in a specific ICGC-ARGO program.',
    fields: [
      {
        name: 'program_id',
        valueType: 'string',
      ...
      },
      {
        ...
        name: 'vital_status',
        restrictions: {
          codeList: ['Alive', 'Dead', 'Not reported'],
          required: true,
        },
        valueType: 'string',
      },
  ...
  },
  {
    name: 'primary_diagnosis',
    description:
      "The collection of data elements related to a donor's primary diagnosis. The primary diagnosis is the first diagnosed case of cancer in a donor.",
    fields: [
      {
        name: 'program_id',
        valueType: 'string',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        restrictions: {
          required: true,
          codeList: ['Muscle', 'Other', 'Unknown', 'Wrist'],
        },
      },
      {
        name: 'central_pathology_confirmed',
  ...
  },
  {
    name: 'follow_up',
    description:
      'The collection of data elements related to a specific follow up visit to a donor. A follow up is defined as any point of contact with a patient after diagnosis.',
    fields: [
      {
        name: 'program_id',
        valueType: 'string',
  ...
  },
  {
    name: 'treatment',
    description:
      "The collection of data elements related to a donor's treatment at a specific point in the clinical record.",
    fields: [
      {
        name: 'program_id',
        valueType: 'string',
  ...
  },
  {
    name: 'chemotherapy',
    description:
      'The collection of data elements describing the details of a chemotherapy treatment completed by a donor.',
    fields: [
      {
        name: 'program_id',
        valueType: 'string',
